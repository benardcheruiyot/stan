...
Write-Host "========================================"
Write-Host ""
Write-Host "Starting server on: https://hella.mkopaji.com:3004" -ForegroundColor Green
Write-Host ""
Write-Host "TO VIEW IN CHROME:" -ForegroundColor Cyan
Write-Host "1. Open Chrome browser" -ForegroundColor White
Write-Host "2. Type in address bar: hella.mkopaji.com:3004" -ForegroundColor White  
