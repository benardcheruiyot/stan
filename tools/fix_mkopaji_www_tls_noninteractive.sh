...
DOMAIN="kopesha.mkopaji.com"
WWW="www.kopesha.mkopaji.com"
...
server {
  listen 80;
  server_name kopesha.mkopaji.com www.kopesha.mkopaji.com;
  return 301 https://kopesha.mkopaji.com$request_uri;
}

server {
  listen 443 ssl;
  ssl_certificate /etc/letsencrypt/live/kopesha.mkopaji.com/fullchain.pem;
  ssl_certificate_key /etc/letsencrypt/live/kopesha.mkopaji.com/privkey.pem;
...
server {
  listen 443 ssl;
  server_name www.kopesha.mkopaji.com;
  ssl_certificate /etc/letsencrypt/live/kopesha.mkopaji.com/fullchain.pem;
  ssl_certificate_key /etc/letsencrypt/live/kopesha.mkopaji.com/privkey.pem;
  ssl_dhparam /etc/letsencrypt/ssl-dhparams.pem;
  return 301 https://kopesha.mkopaji.com$request_uri;
